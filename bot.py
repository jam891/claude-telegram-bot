...
def search_web(query: str) -> str:
    try:
        response = tavily.search(query=query, max_results=3, exclude_domains=["vk.com", "ok.ru", "mail.ru", "yandex.ru", "rbc.ru", "ria.ru", "rt.com"])
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    search_query = text + f" Україна UAH гривна {today} сьогодні"
